...
class DashUI:
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                html.H1(
                                    "🧮 Python Calculator", className="text-center mb-4"
                                )
                            ],
                            width=12,
                        )
                                    ...
                                    [
                                        dbc.CardBody(
                                            [
                                                ...
                                                html.Div(
                                                    id="result-output", className="mt-3"
                                                ),
                                            ]
                                        )
                                    ]
    ...
    def _setup_callbacks(self) -> None:
        ...
        @self.app.callback(
            ...
            [State("num1-input", "value"), State("num2-input", "value")],
            prevent_initial_call=True,
        )
        def quick_operations(
            add_clicks, subtract_clicks, multiply_clicks, divide_clicks, num1, num2
        ):
